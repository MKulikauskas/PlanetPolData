...
xnewone = np.linspace(49.102564, 95.76923077, num=100000, endpoint=True)
...
xnewtwo = np.linspace(48.97435897, 95.76923077, num=100000, endpoint=True)
f2 = interp1d(x=[48.97435897, 60.38461538, 71.66666667, 83.71794872,
95.76923077], y=[2.866666667, 4.333333333, 5.4, 6, 6.088888889], kind='cubic')
#yerr=[0.288888889, 0.555555556, 0.6, 0.46666666666666, 0.377777778]
plt.plot(xnewtwo, f2(xnewtwo))


xnewthree = np.linspace(48.97435897, 95.8974359, num=100000, endpoint=True)
